...
@section('content')
    ...
    <form action="{{ route('pelanggan.update', $pelanggan->pel_id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="pel_ktp" name="pel_ktp" value="{{ old('pel_ktp', $pelanggan->pel_ktp) }}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="pel_meteran" name="pel_meteran" value="{{ old('pel_meteran', $pelanggan->pel_meteran) }}" required>
        </div>
